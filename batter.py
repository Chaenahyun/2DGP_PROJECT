...
class Batter:
    def __init__(self):
        # 타자 sprite
        self.hitter_left_handed = load_image('hitter_left_handed.png')
        self.hitter_right_handed = load_image('hitter_right_handed.png')
        # 타자 idle sprite
        self.idle_hitter_left_handed = load_image('idle_hitter_left_handed.png')
        self.idle_hitter_right_handed = load_image('idle_hitter_right_handed.png')
